                    ...
                    <div className="flex flex-col gap-10 text-left">
                        <Motion direction="right" delay={0.3} duration={0.5}>
                            <div className="flex md:flex-row flex-col justify-start gap-5">
                                ...
                                <h1 className="text-6xl font-bold bg-viridian text-azure line md:px-4">portfolio...</h1>
                            </div>
                        </Motion>
                        <blockquote className="border-l-4 border-viridian pl-4">
                            ...
                            <p>
                                : a hinged cover or flexible case for carrying loose papers,
                                pictures, or pamphlets
                            </p>
                            <p>
                                [from the use of such a case to carry documents of state] : the
                            ...
                            <p>
                                : a set of pictures (such as drawings or photographs) usually bound
                                in book form or loose in a folder
                            </p>
                            <p>
                                : a selection of a student&apos;s work (such as papers and tests)
