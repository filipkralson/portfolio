...
import { SiSpring, SiJavascript, SiTypescript, SiHtml5, SiCss3, SiTailwindcss, SiLinux, SiReact, SiFigma, SiPython, SiFlask, SiGit, SiPostman, SiSwagger, SiDocker, SiMongodb, SiMysql, SiPostgresql } from "react-icons/si";
...
const Card = ({ card }: { card: CardType }) => {
    return (
        <div
            className="group relative md:h-[350px] md:w-[350px] h-[300px] w-[300px] overflow-hidden bg-mintGreen rounded-3xl"
        >
